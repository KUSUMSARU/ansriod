...
import 'package:kusumrental/Bloc/Admin/AdminProductBloc/admin_product_bloc.dart';
import 'package:kusumrental/Bloc/Upload/upload_bloc.dart';
import 'package:kusumrental/Controller/HomeController.dart';
import 'package:kusumrental/Helpers/Colors.dart';
import 'package:kusumrental/Helpers/LoadingUpload.dart';
import 'package:kusumrental/Helpers/ModalFrave.dart';
import 'package:kusumrental/Helpers/ModalLoading.dart';
import 'package:kusumrental/Models/Home/CategoriesProducts.dart';
import 'package:kusumrental/Models/Home/ProductsHome.dart';
import 'package:kusumrental/Widgets/CustomText.dart';
import 'package:kusumrental/Widgets/CustomButton.dart';
    ...
    return BlocListener<AdminProductBloc, AdminProductState>(
      listener: (context, state) {
        if (state is LoadingAddProductState) {
          ...
          Navigator.of(context).pop();
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: CustomText(text: 'Error Updating Product'),
              backgroundColor: Colors.red));
        }
      },
      child: Scaffold(
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              CustomText(text: 'Property Information', fontSize: 18),
              ...
              TextFormField(
                decoration:
                    InputDecoration(hintText: "Enter Property Description"),
              ...
              SizedBox(height: 20.0),
              TextFormField(
                decoration: InputDecoration(hintText: "Enter Property Code"),
              ...
              SizedBox(height: 20.0),
              TextFormField(
                decoration: InputDecoration(hintText: "Enter Total Property"),
                keyboardType: TextInputType.number,
              ...
              SizedBox(height: 20.0),
              TextFormField(
                decoration: InputDecoration(hintText: "Enter Rent"),
                keyboardType: TextInputType.number,
