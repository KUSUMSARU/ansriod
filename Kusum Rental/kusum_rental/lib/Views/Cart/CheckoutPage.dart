...
import 'package:kusumrental/Helpers/modalPayment.dart';
import 'package:kusumrental/Views/Cart/DeliveryPage.dart';
import 'package:kusumrental/Views/Cart/PaymentPage.dart';
  ...
  Future<void> makePayment(double amount) async {
    try {
      ...
      await Stripe.instance.initPaymentSheet(
        ...
        merchantDisplayName: "Kusum Rental ",
      ));
